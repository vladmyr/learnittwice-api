...
class Mongoose {
   ...
   */
  static DefineSchema(schemaDescription: mongoose.SchemaDefinition, options: IDefineSchemaOptions = {}): mongoose.Schema {
  ...
  static DefineModel(modelName: string, schemaDescription: mongoose.SchemaDefinition, options: IDefineSchemaOptions = {}): mongoose.Model<any> {
